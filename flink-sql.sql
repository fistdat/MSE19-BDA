...
CREATE TABLE `iceberg`.`raw_data`.`raw_users` (
    `data` STRING,
    `op` STRING,
    `ts_ms` BIGINT,
    `source_ts_ms` BIGINT,
...
CREATE TABLE `iceberg`.`raw_data`.`raw_accounts` (
    `data` STRING,
    `op` STRING,
    `ts_ms` BIGINT,
    `source_ts_ms` BIGINT,
...
INSERT INTO `iceberg`.`raw_data`.`raw_users` (
    data,
    op,
    ts_ms,
    source_ts_ms,
...
INSERT INTO `iceberg`.`raw_data`.`raw_accounts` (
    data,
    op,
    ts_ms,
    source_ts_ms,
